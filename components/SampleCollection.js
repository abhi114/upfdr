...
import {SampleCollection as data} from './data';
...
const SampleCollection = () => {
  ...
  const DownloadExcel = async () => {
    ...
    console.log(
      ' main path is ' + RNFS.DownloadDirectoryPath + '/SampleCollection.xlsx',
    );
    ...
    RNFS.writeFile(
      RNFS.DownloadDirectoryPath + `/SampleCollection_${timestamp}.xlsx`,
      binaryStr,
      'ascii',
    )
      .then(() => {
  ...
  const generateCSV = async () => {
    ...
    try {
      ...
      const filePath = `${RNFS.DownloadDirectoryPath}/SampleCollection_${timestamp}.csv`;
  ...
  const generatePDF = async () => {
    ...
    let options = {
      html: htmlContent,
      fileName: 'SampleCollection',
      directory: 'Documents',
    };

    let file = await RNHTMLtoPDF.convert(options);
    const timestamp = new Date().getTime();
    const destPath = `${RNFS.DownloadDirectoryPath}/SampleCollection_${timestamp}.pdf`;
    try {
    ...
    <ScrollView contentContainerStyle={styles.scrollContainer}>
      <View style={styles.container}>
        <View style={{flexDirection: 'row', marginBottom: 6}}>
          ...
          <Text style={{color: '#FFFFFF'}}>/Sample Collection Report</Text>
        </View>
        <View style={styles.card}>
          <Text
            style={{color: '#FFFFFF', fontWeight: 'bold', marginBottom: 10}}>
            Roads With Samples Collected
          </Text>
          <View style={{flexDirection: 'row', justifyContent: 'space-between'}}>
            <View>
              ...
              <Text style={{color: '#aaaaaa', fontSize: 12}}>
                Unique Number of Roads With Samples Collected
              </Text>
            </View>
            <View style={{margin: 2}}>
        ...
        <View style={{flexDirection: 'row', marginBottom: 5}}>
          <View
            ...
            <Text
              style={{color: '#FFFFFF', fontWeight: 'bold', marginBottom: 10}}>
              Roads With km-wise Data Updated
            </Text>
            <View
              ...
              <View>
                ...
                <Text style={{color: '#aaaaaa', fontSize: 12}}>
                  Roads With Samples and Kn-wise Data Uploaded
                </Text>
              </View>
              <View style={{margin: 1}}>
        ...
        <FlatList
          ...
          renderItem={({item}) => (
            <View style={styles.card}>
              ...
              <View style={styles.row}>
                <Text style={styles.cellTitle}>Data Uploaded:</Text>
                <Text style={styles.cell}>{item.kmWiseDataUploaded}</Text>
              </View>
              <View style={styles.row}>
          ...
          <Modal
            ...
            <View
              ...
              <ScrollView
                ...
                <View style={styles.row}>
                  <Text style={styles.cellTitle}>DataUploaded:</Text>
                  <Text style={styles.cell}>
                    {selectedItem.kmWiseDataUploaded}
                  </Text>
                </View>
                <View style={styles.row}>
                  <Text style={styles.cellTitle}>District:</Text>
                ...
                <View style={styles.row}>
                  <Text style={styles.cellTitle}>No.JMF Needed</Text>
                  <Text style={styles.cell}>{selectedItem.noOfJMFNeeded}</Text>
                </View>
              </ScrollView>
              <TouchableOpacity
