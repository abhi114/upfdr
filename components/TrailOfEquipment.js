    ...
    <ScrollView contentContainerStyle={styles.scrollContainer}>
      <View style={styles.container}>
        <View style={{flexDirection: 'row', marginBottom: 6}}>
          ...
          <Text style={{color: '#FFFFFF'}}>/ Trail of Equipments</Text>
        </View>
        <View style={styles.card}>
          <Text
            style={{color: '#FFFFFF', fontWeight: 'bold', marginBottom: 10}}>
            Total Trail of Equipments
          </Text>
          <View style={{flexDirection: 'row', justifyContent: 'space-between'}}>
            <View>
              ...
              <Text style={{color: '#aaaaaa', fontSize: 12}}>
                Total Number of Trail of Equipments Uploaded
              </Text>
            </View>
            <View style={{margin: 2}}>
        ...
        <View style={{flexDirection: 'row', marginBottom: 5}}>
          <View
            ...
            <Text
              style={{color: '#FFFFFF', fontWeight: 'bold', marginBottom: 10}}>
              Roads with 5 Essential Trail Of Equipments
            </Text>
            <View
              ...
              <View>
                ...
                <Text style={{color: '#aaaaaa', fontSize: 12}}>
                  Number of Roads with 5 Essential Trail of Equipments
                </Text>
              </View>
              <View style={{margin: 2}}>
          ...
          <View
            ...
            <Text
              style={{color: '#FFFFFF', fontWeight: 'bold', marginBottom: 10}}>
              Roads With Pending Essential Equipments
            </Text>
            <View
              style={{flexDirection: 'row', justifyContent: 'space-between'}}>
              <View>
                ...
                <Text style={{color: '#aaaaaa', fontSize: 12}}>
                  Number of Roads With pending Essential Equipments
                </Text>
              </View>
              <View style={{margin: 1}}>
          ...
          <Modal
            ...
            <View
              ...
              <ScrollView
                ...
                <View style={styles.row}>
                  <Text style={styles.cellTitle}>No Of Equipments:</Text>
                  <Text style={styles.cell}>{selectedItem.noOfEquipments}</Text>
                </View>
                <View style={styles.row}>
                  <Text style={styles.cellTitle}>machine Types:</Text>
                  <Text style={styles.cell}>{selectedItem.machineTypes}</Text>
                </View>
              </ScrollView>
              <TouchableOpacity
...
export default TrailOfEquipment;
